...
class AuthService{
  static Future<void> signIn(String email, String password, String name, String username) async {

    try{
      var url = Uri.parse('https://agripure-mobile-service.onrender.com/auth/newuser');
